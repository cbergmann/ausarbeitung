\documentclass[paper=a4,accentcolor=tud2d]{tudposter}
\usepackage{ngerman}
...
\pagenumbering{arabic}
  \title{\Huge Digital Data Missing?}
  \maketitle
  \huge
  %\birthplace{Darmstadt}
  This pocket normally contains a data storage medium with the digital data and results that were produced during writing this thesis.
  Since this data is partially user data it is not part of the publicly available thesis.
  If you are interested in this data please contact the thesis supervisor.
\end{document}
