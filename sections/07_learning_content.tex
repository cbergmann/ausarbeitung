...
Consequently, as discussed in Section~\ref{s:coverage}, deceiving the user with well-crafted, illegitimate URLs becomes possible. 
...
\begin{description}
	...
	This teaching content will be part of our app, cf.~Section~\ref{s:knowledgetransferperlevel}.	
\end{description}
