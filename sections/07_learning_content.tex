...
PhishTank is a free community site where people can submit, verify and view phishing data.
 ...
 Organizations such as Yahoo, Kaspersky Lab and Mcafee use the data submitted by PhishTank. A further reason to choose PhishTank as our phishing URL database was that a contact at Kaspersky Lab itself recommended to make use of it for our URL analysis.
