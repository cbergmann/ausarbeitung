...
%*******************************************
\label{s:background}
The goal of this chapter is to provide the required background knowledge for our further design elaborations. 
...
For better readability and comprehensibility we divided the available approaches into their content, i.e. what specific content the user is provided with, and the used media, i.e. how this content is provided. Specific examples of previous work are provided in \autoref{s:related_work}.
...
Finally, we state our scope with respect to the term of phishing and provide our own definition which we consider in this work.
%............................................................................................................
\subsubsection{Abstract Definition of Phishing}
%............................................................................................................
\label{s:phishing_def}
Phishing is a term that is used by many people in different contexts. Therefore, the following definition is deliberately kept abstract in order to cover all possible scenarios of phishing.
...
\begin{description}[leftmargin=0cm]
 ...
 Recent research has shown that mobile phone operating systems are as vulnerable to such attacks as desktop systems~\cite{zhou2012dissecting}.
...
For this purpose, psychological manipulation techniques are used, including, but not limited to, exerting pressure or issuing threats.
 ...
 As with e-mails, the text message may contain a link to a fake website, where the user is enticed into divulging sensitive information.
...
For example, with the aid of a social network the phisher might find out that a potential victim likes a specific game. In order to delude this user the phisher might pretend to be the developer of this  game, refer to a severe problem with the user's account and ask him to enter his credentials.
 ...
 Voice phishing is also referred to as vishing.
	...
	\item[Physical letters:] The phisher might even send out real letters to a number of users. We believe that this is unlikely for mass phishing because in contrast to the digital channels, this channel is associated with expenses and more effort. Yet, for spear phishing this attack channel appears especially reasonable because potential targets might not expect it (cf. \autoref{s:phishing_variations}).
...
\begin{description}[leftmargin=0cm]
 ...
 800,000 users of these 8 million e-mail recipients actually click on the contained link and still 80,000 users take the bait according to the estimations~\cite{takethebait}. As discussed in \autoref{s:introduction} the reliability of phishing statistics is questionable. Yet, these numbers indicate a rough overview of the problem.
...
The goal of this section is to introduce the different classes of learning content that we identified in previous work.
...
The goal of this section is to introduce the different classes of learning media that we identified in previous work.
