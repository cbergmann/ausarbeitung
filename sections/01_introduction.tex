...
There are several reasons why we chose to educate users on the smartphone.
 ...
 In addition, given that the majority of the people use a smartphone on a regular basis in Spain, Germany, Italy, France and the UK~\textbf{add to refs(http://www.
comscoredatamine.
