...
As an example, 83\% of Germany's population have Internet access~\autoref{globalfinance2012internetusage}. 
...
Phishing is a form of fraud to lure confidential information from users, cf.~Section~\autoref{s:phishing_def}. The goal of the attacker is to impersonate the user in online systems.
