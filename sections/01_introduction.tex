...
Phishing is a form of fraud to lure confidential information from users, cf.~Section~\ref{s:phishing_def}. The goal of the attacker is to impersonate the user in online systems.
