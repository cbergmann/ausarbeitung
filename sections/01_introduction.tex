...
This thesis consists of eleven main chapters.
...
\newline
\newline
\autoref{s:survey} deals with our initial user survey we had conducted in order to gain some input before elaborating on the app design. After illustrating the main objectives of this survey the chapter presents the results and discusses how the answers influenced our further app elaborations.
\newline
\newline
