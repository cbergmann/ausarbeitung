...
Diese Ans{\"a}tze k{\"o}nnen allerdings keinen rundum zuverl{\"a}ssigen Schutz garantieren, weil es immer L{\"o}sungen geben wird, wie diese Techniken umgangen werden k{\"o}nnen.
...
Bisherige Ans{\"a}tze greifen nicht auf den Benutzer selbst zur{\"u}ck. Dieser ist aber ein entscheidender Faktor, um der Gefahr zu begegnen. Die Erh{\"o}hung des Bewusstseins f{\"u}r Sicherheit und vor allem die Benutzeraufkl{\"a}rung {\"u}ber die Gefahren des Internets sehen wir als weiteren wichtitgen Schritt in Richtung einer ausgereiften Strategie zur Bek{\"a}mpfung von Phishing.

Unsere Masterarbeit besch{\"a}ftigt sich mit der Entwicklung einer Smartphone-App, die das Sicherheitsbewusstsein erh{\"o}ht und die Benutzer bez{\"u}glich Phishing-Erkennung aufkl{\"a}rt und trainiert.
...
Our master's thesis aims at developing a smartphone app, which increases security awareness and educates the user regarding the detection of phishing.
