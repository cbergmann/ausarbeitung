...
Die Studienergebnisse zeigen, dass unsere App den Benutzern hilft bessere Entscheidungen {\"u}ber die Legitimit{\"a}t von URLs zu treffen und erh{\"a}lt von den Anwendern positives Feedback.
\end{abstract}
...
Yet, they all cannot guarantee 100\% accuracy since there will always be ways to circumvent such techniques.
...
To increase the security awareness, the users send themselves a ``spoofed'' e-mail right away when starting the app for the first time.
...
The study outcomes show that our app helps users make better decisions regarding the legitimacy of URLs and receives positive feedback from the users.
\end{abstract}
