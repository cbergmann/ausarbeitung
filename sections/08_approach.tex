...
In Level 1 the game is modified in the form that the user is only presented with valid URLs and has to select the domain. To prevent boring the user in this level we only present 5 URLs. None of them is a phish.

The first level that contain repeats is level 3 because level 2 is the first real game level.
