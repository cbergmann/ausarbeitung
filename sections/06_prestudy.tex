...
%*******************************************
\label{s:survey}
Before elaborating on the app design we ran a phishing survey.
 ...
 Furthermore, it provides details and finally presents the results and evaluates the questionnaire.
...
\begin{enumerate}
 ...
 With the aid of a Likert scale he is requested to assess, for example, whether the would like having a game with a fish, whether he finds a text-based approach appropriate, or whether he would have fun with a question-answer (quiz) game.
	...
	\item \textit{Further Survey Progress} In this part of the survey the user can provide us his e-mail address in case he wants to get information about the further progress of the survey or if he would like to test the app.
...
\begin{description}[leftmargin=0cm]
 ...
 These services are in fact not targeted as often as other services on the Internet, however they are potential targets and should be communicated to the user, for example, with the aid of the choice of the URLs to decide on.
