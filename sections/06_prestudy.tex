...
\begin{description}[leftmargin=0cm]
 ...
 This result roughly relates to the general market share for these platforms and additionally supports our decision for the implementation of an Android application (cf. \autoref{s:sys_requirements}). Overall 202 (81\%) of the unfiltered participants where smartphone users.
...
It reasons whether a possible learning content is transferred to a user and why or why not.
 ...
 \begin{figure}[h!]
 	\centering
 	\includegraphics[width=1\textwidth]{201_Frequency_of_Internet_Usage.pdf}
 	\caption{Frequency of Internet usage}
 	\label{fig:internet_usage}
 	\end{figure}
 	\begin{figure}[h!]
 	\centering
 	\includegraphics[width=1\textwidth]{202_Usage_Applications_Desktop.pdf}%
 	...
 	\begin{figure}[h!]
 	\centering
 	\includegraphics[width=1\textwidth]{204_Usage_Applications_Smartphone.pdf}%
 	\caption{Usage of Internet applications on smartphones}%
 	\label{fig:smartphone_apps}%
 	\end{figure}
 \begin{figure}[h!]
 \centering
 \includegraphics[width=1\textwidth]{401_Endangered_Services.pdf}%
 \caption{Services endangered by phishing}%
 \label{fig:endangered_services}%
 \end{figure}
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{402_Endangered_Data.pdf}%
