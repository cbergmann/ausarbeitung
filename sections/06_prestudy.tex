...
\begin{description}[leftmargin=0cm]
 ...
 This is depicted in \autoref{fig:internet_usage}. Being online is always related with being attackable and vulnerable to dangers of the Internet, such as phishing attacks (cf. Attackability in \autoref{s:target_group_def}), while the extent of the vulnerability of course also depends on other factors, for example, the expertise of the person being online.
...
% These websites can be reached by clicking on a link in an e-mail, SMS, in online social network, or instant messaging systems as well as by simply surfing on the Internet.
 ...
 For this reason, a broad range of categories are reflected in the choice of the example URLs for the final app.
...
In this case it is questionable whether 63.9\% of the participants are in fact capable of protecting themselves against the threats of the Internet.
 ...
 This arouses the suspicion that the users are not aware of how easy it is to spoof the ``from'' field of an e-mail, or to create credible message contents which in fact may persuade the receiver that the e-mail trustworthy.
Therefore, we believe that the user should be made aware of this misconception.
For this reason, the part of the app which is supposed to increase the users' security awareness addresses this issue (cf. \autoref{s:app_design}).
...
We address the misconception of believing that e-mails can be trusted, whether they are received from friends or other trusted parties, with our awareness part of the app (cf. \autoref{s:app_design}).
 ...
 For time reasons we were not able to realize this approach. However, it is something that should be considered for future research.
