...
\begin{description}[leftmargin=0cm]
    \item[Simple text] The simplest way of transporting knowledge to the user is to just write text about it.
    This is the most researched kind of medium and generation over generations of Pedagogues have researched and improved this medium.
