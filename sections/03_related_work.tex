...
Moreover, we state in which way our work is to be expands on previous work. 
...
Finally, the game does not cover some spoofing techniques, which are still relevant in our opinion and thus are covered by us (cf. \autoref{s:url_categories}). 
...
In this case there would be no education at all.
