...
In order to motivate users to attend our user study a gift certificate for the winner of the study was promised.
However, shortly before conducting the study we recognized that not every body might have the same chances to win, due to differences in their expertise or due to, for example, app crashes.
