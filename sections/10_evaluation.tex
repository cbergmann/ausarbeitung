...
%todo: ethical questionable? nein weil aufgeklärt am anfang der Studie.
...
%todo: ethical discussion: nur einer gewinnt ein Gutschein.
\begin{enumerate}
...
%TODO:Limitiations
%Keine Wiederholg nach längerer Zeit
%Verhaltensänderung wegen Studiensituation
%Aufmerksamkeit ist erhöht weil wir vorher schon sagen, dass es phishing ist.
%In situ test ist nicht möglich. 1. zeitlich nicht möglich. 2. ethisch/juristisch fragwürdig
...
%TODO:userausschluss
%Wir schließen Zwei leute aus:
%1.: User war vorher zu gut. [Grafik]
%2.: User hat nicht gespielt.
...
%TODO:wilcoxon 
%TODO:user bis level 10 gekommen. => daher schlechter.	
\item[Hypothesis 2]
...
%TODO:Host marked instead of domain
\begin{figure}
\centering
...
%TODO: Correct and reasoned 37,5% => 75%
%TODO: Survey-after section 3
%TODO: wie weit sind die User gekommen.
%TODO: Future Work: HTTPS vorziehen zahlen nicht nötig
%TODO: Confidence of answers

%TODO:textbf{In this section we consider all of our participants. do we????}  JA
...
%TODO: generelles design könnte peppiger sein (Haputmenü)
