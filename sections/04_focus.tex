...
\begin{description}[leftmargin=0cm]
	...
	We are aware that there are technical approaches to secure DNS (e.g. DNSSEC) but as these are not mandatory nor used on the majority of domains we can not take them into consideration.
