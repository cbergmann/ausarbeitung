...
\hypersetup{%
  pdftitle={Design, Implementation and Evaluation eines Anti-Phishing spiels},
  pdfauthor={Clemens Bergmann und Gamze Canova},
  pdfview=FitH,
  pdfstartview=FitV
}

\setinstitutionlogo{graphix/secuso.png}

\begin{document}
\selectlanguage{american}
  \thesistitle{Design, implementation and evaluation of an anti-phishing game}{Design, Implementation and Evaluation eines Anti-Phishing spiels}
